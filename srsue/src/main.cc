...
static int parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("fuzz.registration_request.mcc",   bpo::value<string>(&args->stack.nas_5g.fuzz_mcc)->default_value(""),  "MCC to pass to the rrcSetupRequest")
    ("fuzz.registration_request.mnc",   bpo::value<string>(&args->stack.nas_5g.fuzz_mnc)->default_value(""),  "MNC to pass to the rrcSetupRequest")
    ("fuzz.registration_request.msin",   bpo::value<string>(&args->stack.nas_5g.fuzz_mnc)->default_value(""),  "msin to pass in rrcSetupRequest")
    ("fuzz.registration_request.cause",   bpo::value<uint32_t>(&args->stack.nas_5g.fuzz_cause)->default_value(0),  "Establishment Caouse for rrcSetupRequest")
    ("fuzz.registration_request.protocol_discriminator",   bpo::value<uint32_t>(&args->stack.nas_5g.fuzz_protocol_discriminatior)->default_value(0),  "registration_request protocol protocol_discriminator (0 | 1)")
    ...
    ("fuzz.registration_request.registration_type",   bpo::value<uint32_t>(&args->stack.nas_5g.fuzz_registration_type)->default_value(0),  "registration_request registration type (1-3)")
