...
static int parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("fuzz.setup_request.msin",   bpo::value<string>(&args->stack.nas_5g.fuzz_mnc)->default_value(""),  "msin to pass in rrcSetupRequest")
    ...
    ("fuzz.setup_request.protocol_discriminator",   bpo::value<uint32_t>(&args->stack.nas_5g.fuzz_protocol_discriminatior)->default_value(0),  "Establishment Caouse for rrcSetupRequest")
